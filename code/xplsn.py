...
def place_lines(inner_radius, outer_radius, max_lines, randomness=DEFAULT_RANDOM_AMOUNT):
...
def build_circle_list(circle_count=DEFAULT_MAX_CIRCLES, canvas_size, relation):
